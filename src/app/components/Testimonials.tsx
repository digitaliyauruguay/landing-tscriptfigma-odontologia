  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        {isMobile ? (
          ...
          <>
            ...
            />
            <div
              className="absolute bottom-40 right-40 w-72 h-72 rounded-full opacity-15"
              style={{ 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Organic header - Conditional animations */}
        {isMobile ? (
        ...
        <div className="relative">
          {/* Featured testimonial - Conditional animations */}
          {isMobile ? (
            <div className="mb-12">
              {testimonials.slice(0, 1).map((testimonial) => (
                ...
                >
                  {/* Quote icon decoration - Mobile: Simplified */}
                  <Quote 
                    size={60} 
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Content */}
                    <p className="text-base lg:text-xl mb-8 leading-relaxed font-medium">
                      "{testimonial.content}"
                    </p>
          ...
          {/* Grid of remaining testimonials - Conditional animations */}
